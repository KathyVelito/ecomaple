		...
		<div className="container mt-4">
			...
			<div className="row">
				<div className="col-sm-12 col-md-6">
					<h4>Productos agregados a su carrito</h4>
					<ul className="list-group">
						{carrito.map((prod, i) => (
							...
							>
								...
								<small className="badge bg-danger rounded-pill p-3">
					...
					<form onSubmit={handleSubmit(recibirSubmit)}>
						...
						<div className="mb-2">
							...
							<input
								...
								{...register("telefono", {
									minLength: { value: 6, message: "Se requiere 9 dígitos" },
						...
						<div className="mb-2">
							...
							<input
								type="text"
								className="form-control"
								placeholder="Ej. Urb. Los Portales de Javier Prado S/N"
